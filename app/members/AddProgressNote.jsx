...
export function AddProgressNote({ member }) {
        ...
        <div className="mx-auto max-w-6xl space-y-6">
          <nav className="text-sm" aria-label="Breadcrumb">
            <ol className="flex flex-wrap items-center gap-2">
              ...
              <li className="font-medium text-gray-600">Add Progress Note</li>
            </ol>
          </nav>

          <BackTitle href={manageHref}>Add Progress Note</BackTitle>
          ...
          <div className="overflow-hidden rounded-xl border border-gray-200/80 bg-white shadow-sm">
            <div className="space-y-5 p-6 sm:p-8">
              ...
              <div className="grid gap-2 sm:grid-cols-[140px_1fr] sm:items-start">
                <span className="pt-2 text-sm font-semibold text-gray-900">Note</span>
                <RichTextEditor onChange={setNoteHtml} />
              </div>
            </div>
            <div className="flex justify-end gap-3 border-t border-gray-100 px-6 py-4 sm:px-8">
              ...
              <button
                type="button"
                disabled={!hasTextFromHtml(noteHtml)}
