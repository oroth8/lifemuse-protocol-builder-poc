...
export const REMINDERS_SENT = [
  ...
  },
  {
    ...
    displayDate: "1/3/26 - 5:00AM",
    to: "John Doe",
    importance: "Low",
    title: "Prep for telehealth",
    description: "Upload vitals and symptom log before your video visit tomorrow.",
  },
  {
    id: "55438",
    createdAt: "2026-01-02T14:20:00.000Z",
    displayDate: "1/2/26 - 9:20AM",
    to: "Maya K.",
    importance: "Medium",
    title: "Refill window opens",
    description: "Your peptide refill is eligible starting today — confirm dose with your clinician.",
  },
  {
    id: "55437",
    createdAt: "2025-12-28T16:00:00.000Z",
    displayDate: "12/28/25 - 11:00AM",
    to: "Alex R.",
    importance: "High",
    title: "Lab draw reminder",
    description: "Bring insurance card and arrive 15 minutes early for your morning draw.",
  },
  {
    id: "55436",
    createdAt: "2025-12-20T09:00:00.000Z",
    displayDate: "12/20/25 - 4:00AM",
    to: "Casey Brown",
    importance: "Medium",
    title: "Year-end goals check-in",
    description: "Quick pulse on protocol adherence before the holiday break.",
  },
];
